...
- **[HandBand>> https://github.com/cong2738/HandBand](https://github.com/cong2738/HandBand)** <br/>
| `SystemVerilog` `verilog` `ISP` `C` `Python` `RTL` `Embedded` `Multithreading` `MIPI` `VDMA` `AMBA AXI` <br/>
...
- **[FlagGame>> https://github.com/cong2738/FlagGame](https://github.com/cong2738/FlagGame)** <br/>
| `SystemVerilog` `RTL` `ISP` `VGA` <br/>
...
- **[RTOS-Winecellar>> https://github.com/cong2738/wine_celler](https://github.com/cong2738/wine_celler)** <br/>
| `C` `Embedded` `RTOS` `ARM Coretex M` <br/>
...
- **[I2C/SPI Team Project>> https://github.com/cong2738/May_team_project_I2C_SPI](https://github.com/cong2738/May_team_project_I2C_SPI)** <br/>
| `SystemVerilog` `C` `RTL` `UVM` <br/>
...
- **[SmartFarmSensorSystem>> https://github.com/cong2738/SmartFarmSensorSystem](https://github.com/cong2738/SmartFarmSensorSystem)** <br/>
| `SystemVerilog` `RTL` `C` `AMBA APB` <br/>
...
- **[my_RISC-V>> https://github.com/cong2738/my_RISC-V](https://github.com/cong2738/my_RISC-V)** <br/>
| `Verilog` `RTL` `C` <br/>
...
- **[출근비서>> https://github.com/cong2738/HarmanCA_project1](https://github.com/cong2738/HarmanCA_project1)** <br/>
| `Python` `API`  <br/>
...
- **[실시간 영상처리를 이용한 로봇 제어의 방법과 필요성>> https://github.com/cong2738/Kangwon_university_senior_project](https://github.com/cong2738/Kangwon_university_senior_project)** <br/>
| `Python` `Deeplearning`  <br/>
